...
directories=(
xeno-calamares-config/
xeno-calamares-config-dev/
xeno-calamares-config-hardened/
xeno-calamares-config-lts/
xeno-calamares-config-pure/
xeno-calamares-config-xanmod/
xeno-calamares-config-zen/
xeno-dwm/
xeno-dwm-nemesis/
xeno-grub-theme/
xeno-iso/
